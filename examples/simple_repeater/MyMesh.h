...
private:
  ...
  uint8_t handleAnonTestReq(mesh::Packet* packet, const mesh::Identity& sender,
...
protected:
  ...
  bool triggerPrivateProbe(const char* pubkey_hex, const char* id, size_t id_len, char* reply);
